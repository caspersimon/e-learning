...
from elearning.components.sidebar import sidebar
...
def menu_button() -> rx.Component:
    ...
    """
    from elearning.elearning import pages
    ...
    return rx.box(
        rx.menu.root(
            ...
            rx.menu.content(
                *[
                    menu_item_link(page["title"], page["path"])
                    for page in pages if page["path"] != "/settings"
                ],
                rx.menu.separator(),
                menu_item_link("Settings", "/settings")
            ...
            return rx.hstack(
                ...
                rx.box(
                    rx.vstack(
                        page_content(),
                        rx.spacer(),
                        # rx.logo(), # this is the "built with reflex" thing
